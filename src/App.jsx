...
export default function App() {
  ...
  useEffect(() => {
    ...
    style.textContent = `
      /* Landscape: quick mode yan yana layout */
      @media (orientation: landscape) and (max-height: 500px) {
        ...
        .quick-mini { grid-template-columns: repeat(4, 1fr) !important; }
      }
      /* Fullscreen: content area bigger */
      :fullscreen .pro-content { padding: 24px !important; }
      /* Smooth orientation transition */
      * { transition: none !important; }
      .layout-transition * { transition: all 0.2s ease !important; }
    `;
  ...
  if (mode==="quick") return (
    ...
    <div style={{ minHeight:"100vh", fontFamily:"'Palatino Linotype',Palatino,serif", background:th.bg, color:th.text, opacity:anim?1:0, transition:"opacity 0.3s" }}>
      ...
      <div className="print-header" style={{ display:"none", background:"#1a1208", color:"white", padding:"14px 18px" }}>
        ...
        <div style={{ fontSize:9, marginTop:3, opacity:0.5 }}>{new Date().toLocaleDateString(lang==="TR"?"tr-TR":"en-GB")}</div>
      </div>
